...
(async function() {
    ...
    function renderBarChart(id, data, options) {
        options = options || {};
        new (0, _autoDefault.default)(document.getElementById(id), {
            type: "bar",
            options: {
                scales: {
                    x: {
    ...
    renderBarChart("dual_flights_by_pilot", [
        ...
        {
            label: "Charlie Dunifer",
            value: 22
        },
        {
            label: "Justin Knaplund",
            value: 17
        },
        {
            label: "Mitch Lubars",
    ...
    renderBarChart("tows_per_day", [
        {
            label: "Smokey Doll (Sat, Mar 4)",
            value: 25
        },
        {
            label: "Peter Jarvis (Sat, Jul 8)",
            value: 17
        },
        {
            label: "Greg Aaron (Sun, Apr 30)",
            value: 16
        },
        {
            label: "Marc Augustin (Sat, Oct 21)",
            value: 16
        },
        {
            label: "Marc Augustin (Sun, Mar 19)",
            value: 16
        },
        {
            label: "Kevin Jackson (Sat, Jan 14)",
            value: 15
        },
        {
            label: "Kelly Butler (Sat, May 27)",
            value: 15
        },
        {
            label: "Lawrence Spinetta (Sat, Jun 10)",
            value: 15
        },
        {
            label: "Tom Barkow (Sat, Sep 2)",
            value: 15
        },
        {
            label: "Greg Aaron (Sun, Feb 5)",
            value: 14
        },
        {
            label: "Charlie Ryan (Sat, Sep 23)",
            value: 14
        }
    ], {
        indexAxis: "y",
    ...
    renderBarChart("flights_per_day", [
        {
            label: "Bill Brinkman (Sun, Jun 25)",
            value: 8
        },
        {
            label: "Greg Aaron (Sat, Aug 5)",
            value: 7
        },
        {
            label: "Andy Maag (Sat, Mar 4)",
            value: 7
        },
        {
            label: "Greg Aaron (Sun, Oct 22)",
            value: 6
        },
        {
            label: "Greg Aaron (Sat, Nov 25)",
            value: 6
        },
        {
            label: "Lawrence Spinetta (Sat, May 27)",
            value: 6
        },
        {
            label: "Bill Brinkman (Sun, Jul 2)",
            value: 6
        },
        {
            label: "Greg Aaron (Sat, Sep 2)",
            value: 6
        },
        {
            label: "Justin Knaplund (Sat, Mar 4)",
            value: 6
        },
        {
            label: "Peter English (Sat, Oct 21)",
            value: 5
        },
        {
            label: "Bill Brinkman (Sat, Jul 29)",
            value: 5
        }
    ], {
        indexAxis: "y",
    ...
    renderBarChart("longest_flights", [
        {
            label: "Ely Bins (Sat, Sep 2)",
            value: 364
        },
        {
            label: "Lawrence Spinetta (Sat, Jul 29)",
            value: 362
        },
        {
            label: "Ely Bins (Sat, Aug 26)",
            value: 360
        },
        {
            label: "Lawrence Spinetta (Wed, Aug 30)",
            value: 360
        },
        {
            label: "Ely Bins (Wed, Aug 30)",
            value: 345
        },
        {
            label: "Ely Bins (Sun, Aug 20)",
            value: 342
        },
        {
            label: "Ely Bins (Thu, Aug 17)",
            value: 323
        },
        {
            label: "Lawrence Spinetta (Thu, Aug 17)",
            value: 320
        },
        {
            label: "Lawrence Spinetta (Sun, Jul 30)",
            value: 315
        },
        {
            label: "Ely Bins (Sat, Jul 29)",
            value: 313
        },
        {
            label: "Lawrence Spinetta (Sun, Sep 3)",
            value: 300
        }
    ], {
        indexAxis: "y",
    ...
    function showCurrent() {
        const slides = document.getElementsByClassName("slide");
        for(let i = 0; i < slides.length; i++)slides[i].className = current == i ? "slide current" : "slide";
    ...
    document.addEventListener("mouseup", function(event) {
        ...
        if (diffX < mouseDelta && diffY < mouseDelta) forward();
    });
})();

},{"chart.js/auto":"d8NN9","chart.js/helpers":"dxsY3","chartjs-plugin-datalabels":"2HIEm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":"2aojw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2HIEm":[function(require,module,exports) {
/*!
...
},{"chart.js/helpers":"dxsY3","chart.js":"ipU8D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8BXtR","bB7Pu"], "bB7Pu", "parcelRequirebfb7")
